                            ...
                            (
                                <div>
                                    ...
                                    <div className="d-flex align-items-center">
                                        ...
                                        {comment.parent_comment.race_weekend != null && <Link className="link-no-decorations" to={`/race-weekends/${comment.parent_comment.race_weekend.id}?comment=${comment.id}`}><span>{comment.text}</span></Link>}                                            
                                    </div>
                                </div>
                            ) 
                            : 
                            (
                                <div>
                                    ...
                                    <div className="d-flex align-items-center">
                                        ...
                                        {comment.race_weekend != null && <Link className="link-no-decorations" to={`/race-weekends/${comment.race_weekend.id}?comment=${comment.id}`}><span>{comment.text}</span></Link>}
                                    </div>
                                </div> 
                            )}
                        </div>
