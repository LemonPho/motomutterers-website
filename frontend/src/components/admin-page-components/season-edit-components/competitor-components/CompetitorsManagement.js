...
import CompetitorCreate from "./create-competitor-components/CreateCompetitorModal";
            ...
            <div className="card-header rounded-15-top">
                <div className="container" style={{paddingLeft: "0px", paddingRight: "0px"}}>
                    <div className="d-flex">
                        <h3>Riders</h3>
                        {!season.finalized && 
                        <button className="btn ms-auto" id="create-competitor-button" onClick={(e) => toggleModal("competitor-create-modal", e)}>
